...
window.LANG = {
  th: {
    ...
    game_lantern_desc: 'อธิษฐานและส่งโคมลอยขึ้นสู่ท้องฟ้าเสมือนจริง ร่วมสืบสานประเพณีจากทุกมุมโลก',
    game_phang_desc: 'เติมแสงสว่างให้แผ่นดินล้านนา จุดประทีปดินเผาบูชาพระพุทธเจ้าและความเป็นสิริมงคล',
    game_krathong_desc: 'ขอขมาพระแม่คงคาและลอยทุกข์โศกไปกับสายน้ำแม่ปิงจำลองที่ส่องสว่างด้วยศรัทธา',
  ...
  en: {
    ...
    game_lantern_desc: 'Make a wish and send a lantern into the digital night sky, joining hearts from around the world.',
    game_phang_desc: 'Illuminate the Lanna land by lighting traditional clay lamps as an offering for prosperity.',
    game_krathong_desc: 'Pay respect to the water goddess and float away your worries on the virtual Ping River.',
