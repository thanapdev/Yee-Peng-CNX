...
window.LANG = {
  ...
  en: {
    ...
    seg4_day1_h:  'Preparations (Before Full Moon)',
    seg4_day1_p:  'Lanna people prepare food, flowers, and candles, hanging lanterns and decorating "Forest Gates" for the festival.',
    seg4_day2_h:  'Yi Peng Day (Morning)',
    seg4_day2_p:  'Visit temples for alms giving, listen to sermons, offer merit to ancestors, and release smoke lanterns.',
    seg4_day3_h:  'Yi Peng Night (Evening)',
    seg4_day3_p:  'Light "Phang Patit" lamps around homes and temples, enjoy the grand parade, and float krathongs in the river.',
